package vn.com.affiliate.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("vn.com.affiliate.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("vn.com.affiliate.security.DomainUserDetailsService", "createSpringSecurityUser");
